...
Begin VB.Form frmmain 
   ...
   Begin VB.Menu zSoubor 
      ...
      Begin VB.Menu zDisconnect 
         Caption         =   "&Discinnect from Server"
         Shortcut        =   ^Q
      End
      Begin VB.Menu zSep9 
         Caption         =   "-"
...
StatusBar1.Panels(2).Text = "Local: Doudle click folder for retreiving files"
End Sub
...
StatusBar1.Panels(2).Text = "Locall: Chose local disc"
End Sub
...
MsgBox "Try to do that the same way couple of times," & vbCrLf & "Then click on help.", vbInformation, "Help"
End Sub
...
If ListView1.SelectedItem Is Nothing Then
    ...
    Exit Sub
Else
    Msg = MsgBox("Are you sure to delete these files?" & vbCrLf & "if you are, don't look for them in recycle!", vbQuestion + vbYesNo, App.Title)
    If Msg = vbYes Then
        For i = 1 To ListView1.ListItems.Count
        If ListView1.ListItems(i).Selected = True Then
...
On Error GoTo Err
    Dim sRet As String
    sRet = InputBox("Type a name of the new folder here", "Nová Složka")
    If sRet <> "" Then
        MkDir strPath & sRet
        Dir1.Refresh
    End If
